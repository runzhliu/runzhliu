...
- 📝 [Agent 评估方法综述：如何公平比较 Pi、OpenClaw、DSH 与 Hermes Agent](https://aik8s.run/ai-k8s/rag-agent/agent-evaluation-overview/) - 2026-09-15
...
📈 Recent activity covers the last **365** days: **997** commits, PRs, reviews and issues across **10** repositories.
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 83 stars · 🍴 8 forks · 35 commits, 10 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 196 commits, 1 PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.9K stars · 🍴 514 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter)** - Go · ⭐ 1.9K stars · 🍴 338 forks · 2 authored PRs  
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 83 stars · 🍴 8 forks · 🕒 updated 2026-09-16  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 🕒 updated 2026-09-16  
  AI/LLM on Kubernetes 基础设施知识库：涵盖 GPU、大数据、调度、分布式训练、LLM 推理、RAG、Agent 与生产运维。
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-15
...
_🕒 Last updated: 2026-09-16 UTC_

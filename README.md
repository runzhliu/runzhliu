...
- 📝 [Kube-apiserver 负载均衡实战：HTTP/2、TLS 终结与四层/七层选型](https://aik8s.run/ai-k8s/practices/kube-apiserver-load-balancing/) - 2026-09-18
- 📝 [万节点 Kubernetes 集群优化实战：控制面、etcd、调度与网络](https://aik8s.run/ai-k8s/practices/large-scale-kubernetes-optimization/) - 2026-09-18
- 📝 [万节点 Kubernetes 集群优化配图](https://aik8s.run/assets/practices/large-scale-kubernetes-optimization/README/) - 2026-09-18
...
📈 Recent activity covers the last **365** days: **1015** commits, PRs, reviews and issues across **10** repositories.

### ✨ Featured Projects

- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 276 stars · 🍴 54 forks · 610 commits, 3 issues  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 86 stars · 🍴 8 forks · 40 commits, 10 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 207 commits, 1 PR  
...
- **[kubeflow/mpi-operator](https://github.com/kubeflow/mpi-operator)** - Go · ⭐ 536 stars · 🍴 238 forks · 4 authored PRs, 1 authored issue, 2 reviewed PRs  
  Kubernetes Operator for MPI-based applications (distributed training, HPC, etc.)
- **[kubernetes/kubernetes](https://github.com/kubernetes/kubernetes)** - Go · ⭐ 128K stars · 🍴 44K forks · 3 authored PRs, 1 reviewed PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.9K stars · 🍴 515 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter)** - Go · ⭐ 1.9K stars · 🍴 339 forks · 2 authored PRs  
  NVIDIA GPU metrics exporter for Prometheus leveraging DCGM
- **[kubernetes-sigs/scheduler-plugins](https://github.com/kubernetes-sigs/scheduler-plugins)** - Go · ⭐ 1.3K stars · 🍴 615 forks · 1 authored PR, 1 reviewed PR  
...
- **[cilium/cilium](https://github.com/cilium/cilium)** - Go · ⭐ 25K stars · 🍴 4.1K forks · 1 authored PR  
...
- **[rook/rook](https://github.com/rook/rook)** - Go · ⭐ 14K stars · 🍴 2.9K forks · 1 authored issue  
  Storage Orchestration for Kubernetes
- **[haoel/haoel.github.io](https://github.com/haoel/haoel.github.io)** - Shell · ⭐ 13K stars · 🍴 2K forks · 1 authored PR
- **[delta-io/delta](https://github.com/delta-io/delta)** - Scala · ⭐ 9K stars · 🍴 2.2K forks · 1 authored PR  
...
- **[kubeovn/kube-ovn](https://github.com/kubeovn/kube-ovn)** - Go · ⭐ 2.4K stars · 🍴 553 forks · 1 authored PR  
  A Bridge between SDN and Cloud Native (Project under CNCF)
- **[ceph/ceph-csi](https://github.com/ceph/ceph-csi)** - Go · ⭐ 1.6K stars · 🍴 619 forks · 1 authored PR  
  CSI driver for Ceph
...
- **[sighupio/permission-manager](https://github.com/sighupio/permission-manager)** - TypeScript · ⭐ 1.4K stars · 🍴 175 forks · 1 authored PR  
  Permission Manager is a project that brings sanity to Kubernetes RBAC and Users management, Web UI FTW
- **[apache/impala](https://github.com/apache/impala)** - C++ · ⭐ 1.3K stars · 🍴 559 forks · 1 authored PR  
  Apache Impala
- **[openebs/lvm-localpv](https://github.com/openebs/lvm-localpv)** - Go · ⭐ 356 stars · 🍴 125 forks · 1 authored PR  
...
- **[k3s-io/docs](https://github.com/k3s-io/docs)** - Shell · ⭐ 33 stars · 🍴 198 forks · 1 authored PR  
  k3s Documentation
...
- **[aik8s/cubesandbox-agent-adapter](https://github.com/aik8s/cubesandbox-agent-adapter)** - Python · ⭐ 2 stars · 19 commits  
...
<details>
<summary>📚 All public repositories (29)</summary>

#### 🧱 Original repositories

- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 86 stars · 🍴 8 forks · 🕒 updated 2026-09-18  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 🕒 updated 2026-09-18  
  AI/LLM on Kubernetes 基础设施知识库：涵盖 GPU、大数据、调度、分布式训练、LLM 推理、RAG、Agent 与生产运维。
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-17
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 276 stars · 🍴 54 forks · 🕒 updated 2026-09-15  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
...
- **[runzhliu/yum-with-browser](https://github.com/runzhliu/yum-with-browser)** - Dockerfile · ⭐ 4 stars · 🕒 updated 2023-04-27
- **[runzhliu/dok](https://github.com/runzhliu/dok)** - ⭐ 3 stars · 🕒 updated 2023-02-15  
  Deployer of Kubernetes Cluster
- **[runzhliu/read-the-books](https://github.com/runzhliu/read-the-books)** - ⭐ 10 stars · 🕒 updated 2022-12-05
- **[runzhliu/container-log-server](https://github.com/runzhliu/container-log-server)** - Go · ⭐ 2 stars · 🕒 updated 2022-11-15
- **[runzhliu/lck-comments](https://github.com/runzhliu/lck-comments)** - ⭐ 0 stars · 🕒 updated 2022-08-19

#### 🍴 Forks and mirrors

- **[runzhliu/kyuubi](https://github.com/runzhliu/kyuubi)** - Scala · ⭐ 0 stars · 🍴 1 fork · 🕒 updated 2026-06-21 · fork  
  Apache Kyuubi is a distributed and multi-tenant gateway to provide serverless SQL on data warehouses and lakehouses.
- **[runzhliu/k8s-etcdkeeper](https://github.com/runzhliu/k8s-etcdkeeper)** - JavaScript · ⭐ 5 stars · 🕒 updated 2026-06-14 · fork  
  web ui client for k8s etcd
- **[runzhliu/OpenCLI](https://github.com/runzhliu/OpenCLI)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-04-12 · fork  
  Make Any Website & Tool Your CLI. A universal CLI Hub and AI-native runtime. Transform any website, Electron app, or local binary into a standardiz...
- **[runzhliu/claude-code](https://github.com/runzhliu/claude-code)** - TypeScript · ⭐ 0 stars · 🕒 updated 2026-04-02 · fork  
  Claude Code Snapshot for Research. All original source code is the property of Anthropic.
- **[runzhliu/agent-sandbox](https://github.com/runzhliu/agent-sandbox)** - Go · ⭐ 0 stars · 🕒 updated 2026-02-04 · fork  
  agent-sandbox enables easy management of isolated, stateful, singleton workloads, ideal for use cases like AI agent runtimes.
- **[runzhliu/DeepSpeedExamples](https://github.com/runzhliu/DeepSpeedExamples)** - Python · ⭐ 0 stars · 🕒 updated 2025-02-03 · fork  
  Example models using DeepSpeed
- **[runzhliu/lvm-localpv](https://github.com/runzhliu/lvm-localpv)** - Go · ⭐ 0 stars · 🕒 updated 2024-12-07 · fork  
  Dynamically provision Stateful Persistent Node-Local Volumes & Filesystems for Kubernetes that is integrated with a backend LVM2 data storage stack.
- **[runzhliu/kubernetes](https://github.com/runzhliu/kubernetes)** - Go · ⭐ 0 stars · 🕒 updated 2024-10-16 · fork  
  Production-Grade Container Scheduling and Management
- **[runzhliu/scheduler-plugins](https://github.com/runzhliu/scheduler-plugins)** - Go · ⭐ 0 stars · 🕒 updated 2024-02-28 · fork  
  Repository for out-of-tree scheduler plugins based on scheduler framework.
- **[runzhliu/cilium](https://github.com/runzhliu/cilium)** - Go · ⭐ 0 stars · 🕒 updated 2024-01-02 · fork  
  eBPF-based Networking, Security, and Observability
- **[runzhliu/ceph-csi](https://github.com/runzhliu/ceph-csi)** - Go · ⭐ 0 stars · 🕒 updated 2023-09-02 · fork  
  CSI driver for Ceph
- **[runzhliu/helm-charts](https://github.com/runzhliu/helm-charts)** - Smarty · ⭐ 0 stars · 🕒 updated 2023-07-07 · fork  
  Our official helm charts for deploying wandb into k8s
- **[runzhliu/dcgm-exporter](https://github.com/runzhliu/dcgm-exporter)** - Go · ⭐ 0 stars · 🕒 updated 2023-05-27 · fork  
  NVIDIA GPU metrics exporter for Prometheus leveraging DCGM
- **[runzhliu/tensile-kube](https://github.com/runzhliu/tensile-kube)** - Go · ⭐ 0 stars · 🕒 updated 2022-11-26 · fork  
  A kubernetes provider
- **[runzhliu/permission-manager](https://github.com/runzhliu/permission-manager)** - TypeScript · ⭐ 0 stars · 🕒 updated 2022-09-07 · fork  
  Permission Manager is a project that brings sanity to Kubernetes RBAC and Users management, Web UI FTW

</details>

_🕒 Last updated: 2026-09-18 UTC_

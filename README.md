...
📈 Recent activity covers the last **365** days: **936** commits, PRs, reviews and issues across **10** repositories.
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 63 stars · 🍴 8 forks · 21 commits, 10 PRs  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.8K stars · 🍴 486 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter)** - Go · ⭐ 1.9K stars · 🍴 332 forks · 2 authored PRs  
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 63 stars · 🍴 8 forks · 🕒 updated 2026-09-05  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 269 stars · 🍴 51 forks · 🕒 updated 2026-09-05  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-05
...
_🕒 Last updated: 2026-09-06 UTC_

...
- 📝 [Qwen3.8-2.4T-A95B-FP8 Day 0：32×H20-3e 双引擎部署与压测](https://aik8s.run/ai-k8s/practices/qwen38-a95b-h20-day0/) - 2026-09-13
- 📝 [Agent Memory 技术综述：智能体怎样记住、更新与忘记](https://aik8s.run/ai-k8s/rag-agent/agent-memory-technology-overview/) - 2026-09-12
- 📝 [Agent Harness 技术综述：模型之外，智能体如何持续完成真实任务](https://aik8s.run/ai-k8s/rag-agent/agent-harness-technology-overview/) - 2026-09-12
...
📈 Recent activity covers the last **365** days: **976** commits, PRs, reviews and issues across **10** repositories.

### ✨ Featured Projects

- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 274 stars · 🍴 53 forks · 610 commits, 3 issues  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 78 stars · 🍴 8 forks · 29 commits, 10 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 15 stars · 🍴 3 forks · 184 commits, 1 PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.8K stars · 🍴 498 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 15 stars · 🍴 3 forks · 🕒 updated 2026-09-13  
  AI/LLM on Kubernetes 基础设施知识库：涵盖 GPU、大数据、调度、分布式训练、LLM 推理、RAG、Agent 与生产运维。
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-12
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 78 stars · 🍴 8 forks · 🕒 updated 2026-09-12  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 274 stars · 🍴 53 forks · 🕒 updated 2026-09-11  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
...
_🕒 Last updated: 2026-09-13 UTC_

...
📈 Recent activity covers the last **365** days: **1041** commits, PRs, reviews and issues across **10** repositories.

### ✨ Featured Projects

- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 279 stars · 🍴 58 forks · 610 commits, 3 issues  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 93 stars · 🍴 9 forks · 44 commits, 11 PRs  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 4K stars · 🍴 527 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter)** - Go · ⭐ 1.9K stars · 🍴 341 forks · 2 authored PRs  
...
- **[cilium/cilium](https://github.com/cilium/cilium)** - Go · ⭐ 26K stars · 🍴 4.1K forks · 1 authored PR  
...
- **[k3s-io/docs](https://github.com/k3s-io/docs)** - Shell · ⭐ 33 stars · 🍴 199 forks · 1 authored PR  
  k3s Documentation
...
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 279 stars · 🍴 58 forks · 🕒 updated 2026-09-24  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 93 stars · 🍴 9 forks · 🕒 updated 2026-09-24  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-23
...
_🕒 Last updated: 2026-09-24 UTC_

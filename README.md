...
📈 Recent activity covers the last **365** days: **710** commits, PRs, reviews and issues across **8** repositories.

### ✨ Featured Projects

- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 239 stars · 🍴 45 forks · 609 commits, 3 issues  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - HTML · ⭐ 1 star · 18 commits
...
- **[kubeflow/mpi-operator](https://github.com/kubeflow/mpi-operator)** - Go · ⭐ 530 stars · 🍴 238 forks · 4 authored PRs, 1 authored issue, 2 reviewed PRs  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.4K stars · 🍴 430 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter)** - Go · ⭐ 1.8K stars · 🍴 320 forks · 2 authored PRs  
...
- **[jackwener/OpenCLI](https://github.com/jackwener/OpenCLI)** - JavaScript · ⭐ 28K stars · 🍴 2.7K forks · 1 authored PR · 1 commit, 1 PR  
...
- **[apache/impala](https://github.com/apache/impala)** - C++ · ⭐ 1.3K stars · 🍴 558 forks · 1 authored PR  
  Apache Impala
- **[openebs/lvm-localpv](https://github.com/openebs/lvm-localpv)** - Go · ⭐ 349 stars · 🍴 123 forks · 1 authored PR  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - HTML · ⭐ 1 star · 🕒 updated 2026-08-04
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-08-03
...
- **[runzhliu/docker-antigravity](https://github.com/runzhliu/docker-antigravity)** - Dockerfile · ⭐ 19 stars · 🍴 3 forks · 🕒 updated 2026-08-01  
  Self-hosted Antigravity in Docker with a browser-accessible GUI via Selkies (WebRTC). No local install needed — deploy on any server or NAS.
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 239 stars · 🍴 45 forks · 🕒 updated 2026-07-29  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
...
_🕒 Last updated: 2026-08-04 UTC_

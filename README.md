...
- 📝 [OpenTelemetry × Grafana 实战：观测 Kubernetes 控制面与集群状态](https://aik8s.run/ai-k8s/practices/opentelemetry-kubernetes-components-grafana/) - 2026-09-16
- 📝 [OpenTelemetry 在 Kubernetes 的应用与实战：从 OTLP 到 Prometheus、Langfuse 与日志管道](https://aik8s.run/ai-k8s/practices/opentelemetry-kubernetes-practice/) - 2026-09-16
- 📝 [LangChain、LangGraph 与 Langfuse Kubernetes 实战：从组件、编排到 Trace](https://aik8s.run/ai-k8s/rag-agent/langchain-langgraph-langfuse-kubernetes-demo/) - 2026-09-16
...
📈 Recent activity covers the last **365** days: **1006** commits, PRs, reviews and issues across **10** repositories.
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 84 stars · 🍴 8 forks · 39 commits, 10 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 200 commits, 1 PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 4K stars · 🍴 516 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[kubernetes-sigs/scheduler-plugins](https://github.com/kubernetes-sigs/scheduler-plugins)** - Go · ⭐ 1.3K stars · 🍴 614 forks · 1 authored PR, 1 reviewed PR  
...
- **[apache/impala](https://github.com/apache/impala)** - C++ · ⭐ 1.3K stars · 🍴 559 forks · 1 authored PR  
  Apache Impala
- **[openebs/lvm-localpv](https://github.com/openebs/lvm-localpv)** - Go · ⭐ 355 stars · 🍴 125 forks · 1 authored PR  
...
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - Shell · ⭐ 84 stars · 🍴 8 forks · 🕒 updated 2026-09-16  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 16 stars · 🍴 3 forks · 🕒 updated 2026-09-16  
  AI/LLM on Kubernetes 基础设施知识库：涵盖 GPU、大数据、调度、分布式训练、LLM 推理、RAG、Agent 与生产运维。
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-09-16
...
_🕒 Last updated: 2026-09-17 UTC_

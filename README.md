...
- 📝 [从 W&B Local 到 SwanLab：两年团队实验追踪实践与选型](https://aik8s.run/ai-k8s/training/wandb-vs-swanlab/) - 2026-08-26
- 📝 [SwanLab 自托管：从 Kubernetes 部署到真实 SFT 指标](https://aik8s.run/ai-k8s/training/swanlab-self-hosted/) - 2026-08-26
...
📈 Recent activity covers the last **365** days: **861** commits, PRs, reviews and issues across **8** repositories.

### ✨ Featured Projects

- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 258 stars · 🍴 49 forks · 610 commits, 3 issues  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - JavaScript · ⭐ 39 stars · 🍴 9 forks · 9 commits, 6 PRs  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 4 stars · 🍴 2 forks · 131 commits, 1 PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 3.6K stars · 🍴 464 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[ceph/ceph-csi](https://github.com/ceph/ceph-csi)** - Go · ⭐ 1.6K stars · 🍴 614 forks · 1 authored PR  
  CSI driver for Ceph
...
- **[apache/impala](https://github.com/apache/impala)** - C++ · ⭐ 1.3K stars · 🍴 559 forks · 1 authored PR  
  Apache Impala
- **[openebs/lvm-localpv](https://github.com/openebs/lvm-localpv)** - Go · ⭐ 352 stars · 🍴 124 forks · 1 authored PR  
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 4 stars · 🍴 2 forks · 🕒 updated 2026-08-26  
  AI/LLM on Kubernetes 基础设施知识库：涵盖 GPU、大数据、调度、分布式训练、LLM 推理、RAG、Agent 与生产运维。
- **[runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker)** - JavaScript · ⭐ 39 stars · 🍴 9 forks · 🕒 updated 2026-08-26  
  Community Docker and Kubernetes packaging for DeepSeek Harness (@deepseek-ai/dsh), with a hardened image, Compose stack, Helm chart, Web UI, and he...
- **[runzhliu/welink](https://github.com/runzhliu/welink)** - TypeScript · ⭐ 258 stars · 🍴 49 forks · 🕒 updated 2026-08-25  
  🔍微信聊天数据分析的本地化AI-agent(Docker/Windows/MacOS) · AI分身 / 大模型分析 / 好友排行 / 词云 / 情感趋势 / 群聊画像
- **[runzhliu/runzhliu](https://github.com/runzhliu/runzhliu)** - JavaScript · ⭐ 0 stars · 🕒 updated 2026-08-25
...
_🕒 Last updated: 2026-08-26 UTC_

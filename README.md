...
- 📝 [MiMo-V2.6-Pro-RL 首测：八张 H20-3e 的 vLLM 部署与性能实测](https://aik8s.run/ai-k8s/practices/mimo-v26-pro-rl-h20-first-test/) - 2026-09-26
...
- **[runzhliu/aik8s](https://github.com/runzhliu/aik8s)** - Python · ⭐ 18 stars · 🍴 3 forks · 221 commits, 1 PR  
...
- **[kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox)** - Go · ⭐ 4K stars · 🍴 528 forks · 2 authored PRs · 1 commit, 2 PRs  
...
- **[ceph/ceph-csi](https://github.com/ceph/ceph-csi)** - Go · ⭐ 1.6K stars · 🍴 620 forks · 1 authored PR  
  CSI driver for Ceph
